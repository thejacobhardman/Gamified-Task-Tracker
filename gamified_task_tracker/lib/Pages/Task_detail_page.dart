...
class _TaskDetailPageState extends State<TaskDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    floatingActionButton:  FloatingActionButton(onPressed: completeTask,
    backgroundColor: Colors.orange,
  ...
  Future<dynamic> completeTask() async {
    ...
    var response = await access.put("/task?task_id=${widget.task.id}", completedTask).catchError((err) {});
    if (response == null) {
    print("null");
    return;
    }
